    ...
    <>
        ...
        <g id="Component_67_9" data-name="Component 67 – 9" transform="translate(9 6)">
          <g transform="matrix(1, 0, 0, 1, -9, -6)" filter="url(#Path_83)">
            <g id="Path_83-2" data-name="Path 83" transform="translate(9 6)" fill="#31354b">
          ...
          <g id="Group_71" data-name="Group 71" transform="translate(19.211 19)">
            ...
            <text id="menuText" transform="translate(-0.21 10)" fill="#fff" font-size="16" font-family="Inter-Regular, Inter"><tspan x="0" y="0">Meny</tspan></text>
          </g>
        </g>
      </svg>
