...
export default function IntroSection(props) {
  return (
    <div id="introWrapper" className={styles.introWrapper}>
      ...
      <p className={styles.hisspitch}>Med vårt smidiga verktyg kan du skicka ut skräddarsydda kuponger direkt till mobilen som mottagaren sedan visar upp på närmaste Pressbyrån eller 7Eleven.</p>
